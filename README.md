...
- `cmake -G "Visual Studio 16 2019" -A x64 -DBOOST_ROOT=C:/local/boost_1_72_0 -DBoost_USE_STATIC_RUNTIME=ON -DBoost_USE_STATIC_LIBS=ON ..` (Or your boost installed dir.)
